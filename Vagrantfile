...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "aclarke-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/humble"
  #   chef.validation_client_name = "humble-validator"
  #   chef.validation_key_path = ".chef/humble-validator.pem"
  # end
end
